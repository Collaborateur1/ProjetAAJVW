...
public class RectoratHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, PostLicence.Rectorat t)
    {
     ...
     */
    public static PostLicence.Rectorat extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return PostLicence.RectoratHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:PostLicence/Rectorat:1.0";
     ...
     */
    public static PostLicence.Rectorat read(org.omg.CORBA.portable.InputStream istream)
    {
        return(PostLicence.Rectorat)istream.read_Object(PostLicence._RectoratStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.Rectorat value)
    {
