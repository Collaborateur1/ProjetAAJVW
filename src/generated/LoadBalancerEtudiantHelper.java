...
public class LoadBalancerEtudiantHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, generated.LoadBalancerEtudiant t)
    {
     ...
     */
    public static generated.LoadBalancerEtudiant extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return generated.LoadBalancerEtudiantHelper.narrow(a.extract_Object());
     ...
     */
    public static generated.LoadBalancerEtudiant read(org.omg.CORBA.portable.InputStream istream)
    {
        return(generated.LoadBalancerEtudiant)istream.read_Object(generated._LoadBalancerEtudiantStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, generated.LoadBalancerEtudiant value)
    {
