...
public class GestionDesVoeuxHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, PostLicence.GestionDesVoeux t)
    {
     ...
     */
    public static PostLicence.GestionDesVoeux extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return PostLicence.GestionDesVoeuxHelper.narrow(a.extract_Object());
     ...
     */
    public static PostLicence.GestionDesVoeux read(org.omg.CORBA.portable.InputStream istream)
    {
        return(PostLicence.GestionDesVoeux)istream.read_Object(PostLicence._GestionDesVoeuxStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.GestionDesVoeux value)
    {
