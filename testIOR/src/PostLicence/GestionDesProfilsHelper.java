...
public class GestionDesProfilsHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, PostLicence.GestionDesProfils t)
    {
     ...
     */
    public static PostLicence.GestionDesProfils extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return PostLicence.GestionDesProfilsHelper.narrow(a.extract_Object());
     ...
     */
    public static PostLicence.GestionDesProfils read(org.omg.CORBA.portable.InputStream istream)
    {
        return(PostLicence.GestionDesProfils)istream.read_Object(PostLicence._GestionDesProfilsStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.GestionDesProfils value)
    {
