...
public class MinistèreHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, PostLicence.Ministère t)
    {
     ...
     */
    public static PostLicence.Ministère extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return PostLicence.MinistèreHelper.narrow(a.extract_Object());
     ...
     */
    public static PostLicence.Ministère read(org.omg.CORBA.portable.InputStream istream)
    {
        return(PostLicence.Ministère)istream.read_Object(PostLicence._MinistèreStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.Ministère value)
    {
