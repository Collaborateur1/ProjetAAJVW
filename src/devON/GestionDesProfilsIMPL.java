...
Hashtable<String,GestionDesVoeux> GestionDesVoeuxInscrit;
int nombreGDV;
...
/*********************Fonction généré******************************/
	...
	public GestionDesVoeux connexion(IEtudiant iorEtudiant, String ine,
		...
		if(etudiantinscrit.contains(ine) )
		{
			if( CodeEtudiantInscrit.get(ine).equals(mdp))
				...
				if(ine.indexOf("G1")!=-1) //si ine contient "G1"  on renvoi GDV1 sinon GDV2 (on fait deux GDV pour linstant)
			    {
				 return GestionDesVoeuxInscrit.get("G1");
			    }
				else
				{
				 return GestionDesVoeuxInscrit.get("G2");	
				}
		}
		// TODO Auto-generated method stub
		return null;
	...
	public void inscriptionGestionDesVoeux(GestionDesVoeux GDesVx) {
		// TODO Auto-generated method stub
	 GestionDesVoeuxInscrit.put("GDV"+nombreGDV, GDesVx);
	 nombreGDV++;
	}
