...
public class IEtudiantHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, PostLicence.IEtudiant t)
    {
     ...
     */
    public static PostLicence.IEtudiant extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return PostLicence.IEtudiantHelper.narrow(a.extract_Object());
     ...
     */
    public static PostLicence.IEtudiant read(org.omg.CORBA.portable.InputStream istream)
    {
        return(PostLicence.IEtudiant)istream.read_Object(PostLicence._IEtudiantStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.IEtudiant value)
    {
