...
public class UniversiteHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, PostLicence.Universite t)
    {
     ...
     */
    public static PostLicence.Universite extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return PostLicence.UniversiteHelper.narrow(a.extract_Object());
    ...
    private final static String _id = "IDL:PostLicence/Universite:1.0";
     ...
     */
    public static PostLicence.Universite read(org.omg.CORBA.portable.InputStream istream)
    {
        return(PostLicence.Universite)istream.read_Object(PostLicence._UniversiteStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.Universite value)
    {
