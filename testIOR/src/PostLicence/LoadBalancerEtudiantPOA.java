        ...
        implements LoadBalancerEtudiantOperations, org.omg.CORBA.portable.InvokeHandler
{
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_getProfil(
        ...
        try
        {
            PostLicence.GestionDesProfils _arg_result = getProfil(arg0_in);

            _output = handler.createReply();
            PostLicence.GestionDesProfilsHelper.write(_output,_arg_result);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_getServProfil(
        ...
        try
        {
            PostLicence.GestionDesProfils _arg_result = getServProfil(arg0_in);
    ...
    private org.omg.CORBA.portable.OutputStream _invoke_inscriptionGDP(
            ...
            final org.omg.CORBA.portable.ResponseHandler handler) {
        org.omg.CORBA.portable.OutputStream _output;
        PostLicence.GestionDesProfils arg0_in = PostLicence.GestionDesProfilsHelper.read(_is);
