...
public class seqFormationsHelper
{
    ...
    {
        a.insert_Streamable(new PostLicence.seqFormationsHolder(t));
    }
    ...
    public static PostLicence.Formation[] extract(org.omg.CORBA.Any a)
    {
        ...
        if(HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof PostLicence.seqFormationsHolder)
                    return ((PostLicence.seqFormationsHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            PostLicence.seqFormationsHolder h = new PostLicence.seqFormationsHolder(read(a.create_input_stream()));
    ...
    public static org.omg.CORBA.TypeCode type()
    {
        if (_tc == null) {
            ...
            _tc = orb.create_alias_tc(id(),"seqFormations",orb.create_sequence_tc(0,PostLicence.FormationHelper.type()));
        }
        return _tc;
    }
    ...
    {
        PostLicence.Formation[] new_one;
        {
        int size7 = istream.read_ulong();
        new_one = new PostLicence.Formation[size7];
        for (int i7=0; i7<new_one.length; i7++)
         {
            new_one[i7] = PostLicence.FormationHelper.read(istream);
    ...
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.Formation[] value)
    {
        ...
        {
            PostLicence.FormationHelper.write(ostream,value[i7]);
