...
public class UtilisationInterditeHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, PostLicence.UtilisationInterdite t)
    {
        a.insert_Streamable(new PostLicence.UtilisationInterditeHolder(t));
    }
     ...
     */
    public static PostLicence.UtilisationInterdite extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof PostLicence.UtilisationInterditeHolder)
                    return ((PostLicence.UtilisationInterditeHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            PostLicence.UtilisationInterditeHolder h = new PostLicence.UtilisationInterditeHolder(read(a.create_input_stream()));
     ...
     */
    public static PostLicence.UtilisationInterdite read(org.omg.CORBA.portable.InputStream istream)
    {
        PostLicence.UtilisationInterdite new_one = new PostLicence.UtilisationInterdite();
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, PostLicence.UtilisationInterdite value)
    {
